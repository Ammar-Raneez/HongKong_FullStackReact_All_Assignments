...
//origins server must accept, server, testing localhost, and our computer localhost
const localhost = process.env.PORT;
const whitelist = [localhost, 'http://localhost:3000', 'https://localhost:3443', 'http://DESKTOP-5UU3U4U:3001'];
